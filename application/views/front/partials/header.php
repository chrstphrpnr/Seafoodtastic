...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-custom sticky-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="<?php echo base_url().'home/index';?>"><i class="fas fa-fish"></i> Seafoodtastic</a>
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url().'category/index';?>">PRODUCTS</a>
                    </li>

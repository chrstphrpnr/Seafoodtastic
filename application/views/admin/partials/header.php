                    ...
                    <li class="nav-item dropdown active ">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item"
                                href="<?php echo base_url().'admin/category/create_category';?>">Create Category</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown active">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?php echo base_url().'admin/product/';?>">Manage Product</a>
                            <a class="dropdown-item" href="<?php echo base_url().'admin/product/create_product';?>">Create
                            Product</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown active">
